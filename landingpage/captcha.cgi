  ...
  <form method="get" action="check.cgi">
    <table>
      ...
      <tr>
        ...
        <td>
          ' . $image . '<a 
href="javascript:captchas_image_reload(\'captchas.net\')">Bild neu 
laden.</a>
          <br> <a href="' . $audio_url . '">Phonetic spelling (mp3)</a>
          <br> <a href="' . $audio_url . '&language=de">Buchstabieren 
(mp3)</a>
          <br> <a href="' . $audio_url . '&language=it">Compitare 
(mp3)</a>
          <br> <a href="' . $audio_url . '&language=nl">Spellen 
(mp3)</a>
